...
function crud_sample_tumbuhan() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "List Data Sample Tumbuhan",
            edit: false,
        },
        ...
        methods: {
            ...
            fetchData: function() {
                var vm = this
                var domain  = laroute.route('cms_sample_tumbuhan_data', []);
            ...
            storeData: function(event) {
                ...
                $("#form__sample_tumbuhan").ajaxForm(optForm);
                $("#form__sample_tumbuhan").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('cms_permohonan_edit', []);
