...
function crud_verifikasi_hewan() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            data: {},
            form_add_title: "Verifikasi Karantina Hewan",
            edit: false,
        },
        ...
        methods: {
            ...
            storeData: function(event) {
                ...
                $("#form__verifikasi_karantina_hewan").ajaxForm(optForm);
                $("#form__verifikasi_karantina_hewan").submit();
            },
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Verifikasi Karantina Hewan"
