...
function crud_master_dokter() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            data: {},
            form_add_title: "List Data Dokter",
            edit: false,
        },
        ...
        methods: {
            ...
            fetchData: function() {
                var vm = this
                var domain  = laroute.route('cms_master_dokter_data', []);
            ...
            storeData: function(event) {
                ...
                $("#form__master_dokter").ajaxForm(optForm);
                $("#form__master_dokter").submit();
            },
            ...
            resetForm: function() {
                ...
                this.form_add_title = "List Data Dokter"
