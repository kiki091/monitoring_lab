...
function menu_master_laboratorium()
{
    $('.right_col').load(laroute.route('cms_master_laboratorium_index', []), function()
    {
        init_master_laboratorium()
    });
}
// JAVASCRIPT 
...
function menu_master_perusahaan()
{
    $('.right_col').load(laroute.route('cms_master_perusahaan_index', []), function()
    {
        init_master_perusahaan()
    });
}
// JAVASCRIPT 
