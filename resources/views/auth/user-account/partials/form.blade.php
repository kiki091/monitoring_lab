				...
				<div class="create__form content__tab active__content">
					<div class="form__group__row">
						<div id="form-accordion">
							...
							<div class="create__form__row">
								<span class="form__group__title">User Access Control<a href="javascript:void(0);" class="style__accordion" data-accordion="form-accordion-2"><i>@include('svg-logo.ico-expand-arrow')</i></a></span>
							</div>
