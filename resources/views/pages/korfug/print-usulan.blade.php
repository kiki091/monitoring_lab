...
<body>
	...
	<p class="title_pages">Form Usulan Penunjukan Penyelia dan Analis Pengujian</p>
	...
	<table class="table" border="1" cellpadding="1" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<th style="text-align: center;">Penyelia</th>
			...
			<tr>
				...
				@foreach($korfug as $key=> $val)
					@foreach($val as $key_dat=> $data)
						<td style="text-align: center;">{{ $data['dokter'] }} ,</td>
					@endforeach
				@endforeach
			</tr>
		</tbody>
