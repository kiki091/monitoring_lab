<form action="{{ route('cms_master_kegiatan_store') }}" method="POST" id="form__master_kegiatan" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="create__form__row">
									...
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nama_kegiatan" name="nama_kegiatan" type="text" id="nama_kegiatan" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_kegiatan"></div>
									</div>
								</div>
							</div>
						</div>
