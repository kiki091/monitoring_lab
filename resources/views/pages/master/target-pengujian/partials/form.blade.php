<form action="{{ route('cms_master_target_pengujian_store') }}" method="POST" id="form__master_target_pengujian" enctype="multipart/form-data" @submit.prevent>
							...
							<div id="form-accordion-1" style="display: block;">
								<div class="create__form__row">
									...
									<div class="new__form__field">
										<label>Nama Target Pengujian</label>
										<div class="field__icon">
											<input v-model="models.nama_target_pengujian" name="nama_target_pengujian" type="text" id="nama_target_pengujian" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_target_pengujian"></div>
									</div>
								</div>
							</div>
						</div>
