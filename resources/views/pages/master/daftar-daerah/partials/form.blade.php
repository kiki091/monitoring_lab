<form action="{{ route('cms_master_daftar_daerah_store') }}" method="POST" id="form__master_daftar_daerah" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="create__form__row">
									...
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nama_daerah" name="nama_daerah" type="text" id="nama_daerah" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_daerah"></div>
									</div>
								</div>
							</div>
						</div>
