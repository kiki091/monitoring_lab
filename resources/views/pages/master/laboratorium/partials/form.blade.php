<form action="{{ route('cms_master_laboratorium_store') }}" method="POST" id="form__master_laboratorium" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="create__form__row">
									...
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nama_laboratorium" name="nama_laboratorium" type="text" id="nama_laboratorium" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_laboratorium"></div>
									</div>
								</div>
							</div>
						</div>
