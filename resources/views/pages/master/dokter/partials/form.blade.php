<form action="{{ route('cms_master_dokter_store') }}" method="POST" id="form__master_dokter" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="create__form__row">
									...
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nip_dokter" name="nip_dokter" type="text" id="nip_dokter" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nip_dokter"></div>
									</div>
