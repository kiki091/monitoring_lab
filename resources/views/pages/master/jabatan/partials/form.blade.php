<form action="{{ route('cms_master_jabatan_store') }}" method="POST" id="form__master_jabatan" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="create__form__row">
									...
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nama_jabatan" name="nama_jabatan" type="text" id="nama_jabatan" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_jabatan"></div>
									</div>
								</div>
							</div>
						</div>
