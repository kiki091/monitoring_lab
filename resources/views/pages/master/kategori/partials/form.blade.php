<form action="{{ route('cms_master_kategori_store') }}" method="POST" id="form__master_kategori" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="create__form__row">
									...
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nama_kategori" name="nama_kategori" type="text" id="nama_kategori" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_kategori"></div>
									</div>
								</div>
							</div>
						</div>
