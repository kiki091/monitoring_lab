<form action="{{ route('cms_master_media_transpor_store') }}" method="POST" id="form__master_media_transpor" enctype="multipart/form-data" @submit.prevent>
							...
							<div id="form-accordion-1" style="display: block;">
								<div class="create__form__row">
									...
									<div class="new__form__field">
										<label>Nama Media Transpor</label>
										<div class="field__icon">
											<input v-model="models.nama_media_transpor" name="nama_media_transpor" type="text" id="nama_media_transpor" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_media_transpor"></div>
									</div>
								</div>
							</div>
						</div>
