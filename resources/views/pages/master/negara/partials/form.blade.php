<form action="{{ route('cms_master_negara_store') }}" method="POST" id="form__master_negara" enctype="multipart/form-data" @submit.prevent>
							...
							<div id="form-accordion-1" style="display: block;">
								<div class="create__form__row">
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.kode_negara" name="kode_negara" type="text" id="kode_negara" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--kode_negara"></div>
									</div>
								</div>
								...
								<div class="create__form__row">
									<div class="new__form__field">
										...
										<div class="field__icon">
											<input v-model="models.nama_negara" name="nama_negara" type="text" id="nama_negara" class="form-control" placeholder="Enter here">
										</div>
										<div class="form--error--message--left" id="form--error--message--nama_negara"></div>
									</div>
								</div>
							</div>
						</div>
